...
(def entity-vec [{:_id (object-id)
                  ...
                  :description "Problem with your Washing Machine? Not a big deal now, get expert within no time ... we fix all types of Washing maching(Fully-automatic, semi-automatic) from top brands like svmsung, LG, Godrej, whirlpool"}
                 {:_id (object-id)
